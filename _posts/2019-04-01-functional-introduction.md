...
* alternative-title "Świat monadów, funktorów, vavra, kotlina, słowem wstęp do świata funkcji"- opisz co to Functor...

* alternative-title "Świat monadów, funktorów, vavra, do tego Kotlin, czyli wstęp do funkcji"

* BEST-alternative-title "Świat monadów, funktorów, Kotlina, Vavra, czyli wszystko co potrzebne do..."
