...
<img height="500px" src="/assets/img/posts/2019-xx-xx-view-encapsulation/devtools_config_shadow_dom.jpg" />
//TODO screen
...
Dzięki temu na stronie możem istnieć kilka komponentów zawierających znacznik tego samego typu, ale z różnymi stylami. W tym trybie **style rodzica nie mają wpływu na elementy dziecka!**
...
W tym trybie style nie są dodawane w sekcji `<head>`, a istnieją w **Shadow Root** komponentu i **mają wpływ na komponenty dzieci!**
