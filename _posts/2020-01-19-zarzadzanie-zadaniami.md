...
#### Zapisywanie zadań
<!-- kiedy tylko myśl nabierze kształtu, jak najprościej! -->
...
#### Przegląd zadań
<!-- REGULARNIE, często, łatwo, przejść całą listę, usunąć nieaktualne, uzupełnić, poprawić -->
...
#### Wykonanie zadań
<!-- pierwsze na liście, skupić się na zadaniu, jak przy okazji wyjdzie "coś" - zapisać jako nowe zadanie -->
...
* ustawić przypomnienie
  * czasowe
  * geograficzne (np. _"jak wejdę do Castorama"_) - brzmi fajnie, przydatność taka sobie w moim przypadku
