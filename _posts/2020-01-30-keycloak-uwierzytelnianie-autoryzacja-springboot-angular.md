...
![Public component](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/public_component_not_logged.png)
...
![Keycloak Configuration](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/keycloak_config.png)
...
![Keycloak login](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/keycloak_login.png)
...
![Public component](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/public_component_logged.png)

Dodatkowo mamy jeszcze tylko przycisk `Logout (frontend)`. Jesteśmy teraz zalogowani, więc możemy przejść do `Protected`:

![Protected component](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/protected_component.png)

Zadziała również `Backend Hello`:

![Backend Hello](/assets/img/posts/2020-01-30-keycloak-uwierzytelnianie-autoryzacja-springboot-angular/backend_hello.png)
